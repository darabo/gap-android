...
class FileTransferTest {
    ...
    fun `replaceFilePathInContent should correctly format content markers for different file types`() {
        ...
        val imageMessage = BitchatMessage(
            ...
            content = "/data/user/0/com.gap.android/files/images/photo.jpg",
        ...
        val audioMessage = BitchatMessage(
            ...
            content = "/data/user/0/com.gap.android/files/audio/voice.amr",
        ...
        val fileMessage = BitchatMessage(
            ...
            content = "/data/user/0/com.gap.android/files/documents/document.pdf",
        ...
        result = result.replace(
            "/data/user/0/com.gap.android/files/images/photo.jpg",
            "[image] photo.jpg"
        )
