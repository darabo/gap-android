...
import com.gap.android.mesh.PeerFingerprintManager
import com.gap.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.gap.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.gap.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.gap.android.noise.southernstorm.protocol.Noise.createDH("25519")
     ...
     */
    fun signPacket(packet: com.gap.android.protocol.BitchatPacket): com.gap.android.protocol.BitchatPacket? {
     ...
     */
    fun verifyPacketSignature(packet: com.gap.android.protocol.BitchatPacket, publicKey: ByteArray): Boolean {
