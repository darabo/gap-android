...
import com.gap.android.nostr.NostrProofOfWork
...
import com.gap.android.net.TorPreferenceManager
                ...
                LazyColumn(
                    ...
                    item(key = "appearance") {
                        Column(modifier = Modifier.padding(horizontal = 20.dp)) {
                            ...
                            val themePref by com.gap.android.ui.theme.ThemePreferenceManager.themeFlow.collectAsState()
                            Surface(
                                modifier = Modifier.fillMaxWidth(),
                                color = colorScheme.surface,
                                shape = RoundedCornerShape(16.dp)
                                ...
                                Row(
                                    ...
                                    ThemeChip(
                                        ...
                                        onClick = { com.gap.android.ui.theme.ThemePreferenceManager.set(context, com.gap.android.ui.theme.ThemePreference.System) },
                                        modifier = Modifier.weight(1f)
                                    )
                                    ThemeChip(
                                        label = stringResource(R.string.about_light),
                                        selected = themePref.isLight,
                                        onClick = { com.gap.android.ui.theme.ThemePreferenceManager.set(context, com.gap.android.ui.theme.ThemePreference.Light) },
                                        modifier = Modifier.weight(1f)
                                    )
                                    ThemeChip(
                                        label = stringResource(R.string.about_dark),
                                        selected = themePref.isDark,
                                        onClick = { com.gap.android.ui.theme.ThemePreferenceManager.set(context, com.gap.android.ui.theme.ThemePreference.Dark) },
                                        modifier = Modifier.weight(1f)
                                    )
                                }
                            }
                    ...
                    item(key = "settings") {
                        ...
                        var backgroundEnabled by remember { mutableStateOf(com.gap.android.service.MeshServicePreferences.isBackgroundEnabled(true)) }
                                ...
                                Column {
                                    ...
                                    SettingsToggleRow(
                                        ...
                                        onCheckedChange = { enabled ->
                                            ...
                                            com.gap.android.service.MeshServicePreferences.setBackgroundEnabled(enabled)
                                            if (!enabled) {
                                                com.gap.android.service.MeshForegroundService.stop(context)
                                            } else {
                                                com.gap.android.service.MeshForegroundService.start(context)
                                            }
                                        }
                                    )
