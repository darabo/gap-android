...
import com.gap.android.onboarding.BluetoothCheckScreen
import com.gap.android.onboarding.BluetoothStatus
import com.gap.android.onboarding.BluetoothStatusManager
import com.gap.android.onboarding.BatteryOptimizationManager
import com.gap.android.onboarding.BatteryOptimizationPreferenceManager
import com.gap.android.onboarding.BatteryOptimizationScreen
import com.gap.android.onboarding.BatteryOptimizationStatus
import com.gap.android.onboarding.InitializationErrorScreen
import com.gap.android.onboarding.InitializingScreen
import com.gap.android.onboarding.LocationCheckScreen
import com.gap.android.onboarding.LocationStatus
import com.gap.android.onboarding.LocationStatusManager
import com.gap.android.onboarding.OnboardingCoordinator
import com.gap.android.onboarding.OnboardingState
import com.gap.android.onboarding.PermissionExplanationScreen
import com.gap.android.onboarding.PermissionManager
import com.gap.android.ui.ChatScreen
import com.gap.android.ui.ChatViewModel
import com.gap.android.ui.OrientationAwareActivity
import com.gap.android.ui.theme.BitchatTheme
...
class MainActivity : OrientationAwareActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try { com.gap.android.service.MeshForegroundService.start(applicationContext) } catch (_: Exception) { }
        meshService = com.gap.android.service.MeshServiceHolder.getOrCreate(applicationContext)
    ...
    private fun initializeApp() {
        ...
        lifecycleScope.launch {
            try {
                ...
                com.gap.android.nostr.LocationNotesInitializer.initialize(this@MainActivity)
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.gap.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.gap.android.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.gap.android.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.gap.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.gap.android.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.gap.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.gap.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.gap.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.gap.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.gap.android.geohash.GeohashChannelLevel.REGION
                        else -> com.gap.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.gap.android.geohash.GeohashChannel(level, geohash)
                    val channelId = com.gap.android.geohash.ChannelID.Location(geohashChannel)
