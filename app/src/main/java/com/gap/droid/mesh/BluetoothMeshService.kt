    ...
    private fun setupDelegates() {
        ...
        peerManager.delegate = object : PeerManagerDelegate {
            ...
            override fun onPeerRemoved(peerID: String) {
                ...
                try { com.gapmesh.droid.services.meshgraph.MeshGraphService.getInstance().removePeer(peerID) } catch (_: Exception) { }
        ...
        serviceScope.launch {
            ...
            try {
                ...
                if (directPeers.isNotEmpty()) {
                    val gossip = com.gapmesh.droid.services.meshgraph.GossipTLV.encodeNeighbors(directPeers)
        ...
        return try {
            ...
            val withRoute = try {
                ...
                if (rec != null && !rec.contentEquals(SpecialRecipients.BROADCAST)) {
                    ...
                    val path = com.gapmesh.droid.services.meshgraph.RoutePlanner.shortestPath(myPeerID, dest)
