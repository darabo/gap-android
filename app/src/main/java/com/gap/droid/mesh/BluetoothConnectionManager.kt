...
class BluetoothConnectionManager(
    ...
    // Callback for outbound packets (allows other transports to piggyback)
    var onPacketOutbound: ((BitchatPacket, String?) -> Unit)? = null // packet, specificPeerID (null=broadcast)
    ...
    fun broadcastPacket(routed: RoutedPacket) {
        ...
        // Notify listener (e.g. WiFi Aware service)
    ...
    fun sendPacketToPeer(peerID: String, packet: BitchatPacket): Boolean {
        ...
        // Notify listener (e.g. WiFi Aware service)
        onPacketOutbound?.invoke(packet, peerID)
